...
public class ReservationServiceImpl implements ReservationService{
    ...
    public ReservationServiceImpl(
            ...
            CarServicesServiceImpl carServicesServiceImpl,
    ...
    public boolean saveReservation(Reservation reservation) throws ParseException {
        ...
        int execution_time = carServicesServiceImpl
        ...
        if(
            ...
            reservation.setCarServices(carServicesServiceImpl.findCarServiceById(reservation.getCarServices().getId()));
